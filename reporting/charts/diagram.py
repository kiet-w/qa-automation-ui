...
def generate_system_architecture_diagram_svg(
    ...
    nodes = [
        ...
        },
        {
            ...
            "details": ["BingHomePage & Results", "YouTubePage Actions", "Zero Assertions in POM"],
            "badge": "AUTOMATION",
            "focal": False,
        },
        {
            ...
            "details": ["1080p WebM Recordings", "Step 5 Screenshot PNG", "Structured report.json"],
            "badge": "DELIVERABLES",
            "focal": False,
        },
        {
    ...
    layers = [
        {
            ...
            "meta": "Run ID, CI Trigger, Git Ref, Brave 1080p, Jira (PROJ-1042)",
